...
export declare type CoerceTypes = {
    Array: 'array' | 'ARRAY';
...
export declare type ContainsArgType<T> = Primitives | any[] | Record<string, unknown> | Func<T>;
...
export interface RDatum<T = any> extends RQuery<T> {
    ...
    contains<U = T extends Array<infer T1> ? T1 : never>(val1: ContainsArgType<U>, ...value: Array<ContainsArgType<U>>): T extends Array<infer T1> ? RDatum<boolean> : never;
    ...
    coerceTo<U = any>(type: CoerceTypes['Object']): T extends Array<infer T1> ? RDatum<U> : never;
    coerceTo(type: CoerceTypes['String']): RDatum<string>;
    coerceTo(type: CoerceTypes['Array']): RDatum<any[]>;
    coerceTo(type: CoerceTypes['Number']): T extends string ? RDatum<number> : never;
    coerceTo(type: CoerceTypes['Binary']): T extends string ? RDatum<Buffer> : never;
...
export interface RStream<T = any> extends RQuery<T[]> {
    ...
    contains(val1: ContainsArgType<T>, ...value: Array<ContainsArgType<T>>): RDatum<boolean>;
...
export interface R {
    ...
    contains<T, U = T extends Array<infer T1> ? T1 : never>(datum: RDatum<T>, val1: ContainsArgType<U>, ...value: Array<ContainsArgType<U>>): T extends Array<infer T1> ? RDatum<boolean> : never;
    contains<T>(stream: RStream<T>, val1: ContainsArgType<T>, ...value: Array<ContainsArgType<T>>): RDatum<boolean>;
    ...
    coerceTo<T, U = any>(stream: RStream<T>, type: CoerceTypes['Object']): RDatum<U>;
    coerceTo<T, U = any>(datum: RDatum<T>, type: CoerceTypes['Object']): T extends Array<infer T1> ? RDatum<U> : never;
    ...
    coerceTo<T>(datum: RDatum<T>, type: CoerceTypes['Number']): T extends string ? RDatum<number> : never;
    coerceTo<T>(datum: RDatum<T>, type: CoerceTypes['Binary']): T extends string ? RDatum<Buffer> : never;
